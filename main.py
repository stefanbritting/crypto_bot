...
"""
domain_space    = [hp.quniform('periods_bol', 10, 800, q=1), hp.quniform('periods_adx', 10, 800, q=1), hp.quniform('periods_rsi', 10, 800, q=1), hp.quniform('adx_value', 20, 26, q=1)]
...
def normal_sim():
    ...
    df          = data.load()
    strategy    = Strategy(df=df, periods_bol = 760, periods_adx = 56,periods_rsi = 615, adx_value = 20)
    account     = Account(balance={"euro": 1000, "btc": 0}, av_balance = 0.8)
